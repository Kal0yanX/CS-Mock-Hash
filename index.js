...
hashPassword = async (username, password) => {
    ...
    let rds = 12 //salt Rounds
    
    let pwHash = await bcrypt.hash(password, rds)
    ...
    console.log('User ' + username + 'has been added. Your password hash is :' + pwHash)
    console.log('globalStore', globalStore[username])
}
